...
a persistence unit "Javaee-PracticoPersistenceUnit" which uses the JakartaEE default database.
...
The configuration can be found in "Javaee-Practico/pom.xml":
...
artifacts ("Javaee-Practico-ejb.jar" and "Javaee-Practico-web.war") are already built. You can build
